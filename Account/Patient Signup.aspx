<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.master" AutoEventWireup="true" CodeFile="Patient Signup.aspx.cs" Inherits="Account_Patient_Signup" %>
                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-md-12 col-lg-6 login-right">
                                <div class="login-header">
                                    <h3>Patient Register <a id="txtError" class="text-danger" runat="server"></a></h3>
                                </div>
                                ...
                                <!-- Register Form -->
                                    ...
                                    <div class="form-group form-focus">
                                        <asp:TextBox ID="txtRePassword" runat="server" class="form-control floating" TextMode="Password" />
                                        <label class="focus-label">Retype Password</label>
                                        <asp:RequiredFieldValidator ID="req4" runat="server" Display="Dynamic" ErrorMessage="Please enter re-password" ControlToValidate="txtRePassword"
                                            CssClass="text-danger" />
                                        <asp:CompareValidator ID="cv1" runat="server" ErrorMessage="Password does not match" ControlToCompare="txtPassword"
                                            ControlToValidate="txtRePassword" CssClass="text-danger"/>
                                    </div>
                                    <div class="form-group form-focus">
                                    ...
                                    <asp:Button ID="btnRegister" runat="server" class="btn btn-primary btn-block btn-lg login-btn" Text="Signup" OnClick="btnRegister_Click" />
                                    <div class="login-or">
